...
{
    public class MysticBowcraftVendor : BaseVendor
    {
        private ArrayList m_SBInfos = new ArrayList();
        protected override ArrayList SBInfos { get { return m_SBInfos; } }

        [Constructable]
        public MysticBowcraftVendor()
            : base("the Mystic Bowcrafterer")
        {
        ...
        {
            m_SBInfos.Add(new SBMysticBowcraftVendor());
        }
        ...
        public MysticBowcraftVendor(Serial serial)
            : base(serial)
        {
        }
