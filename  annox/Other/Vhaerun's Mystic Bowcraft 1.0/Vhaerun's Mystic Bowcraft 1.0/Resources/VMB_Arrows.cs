...
namespace Server.Items
{
    ...
    public class BloodArrow : Item, ICommodity
    {
        ...
        public BloodArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class PoisonArrow : Item, ICommodity
    {
        ...
        public PoisonArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DragonArrow : Item, ICommodity
    {
        ...
        public DragonArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class MoonArrow : Item, ICommodity
    {
        ...
        public MoonArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FalconArrow : Item, ICommodity
    {
        ...
        public FalconArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class StarArrow : Item, ICommodity
    {
        ...
        public StarArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DarkArrow : Item, ICommodity
    {
        ...
        public DarkArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ZodiacArrow : Item, ICommodity
    {
        ...
        public ZodiacArrow(Serial serial)
            : base(serial)
        {
        }
    ...
    public class WaterBolt : Item, ICommodity
    {
        ...
        public WaterBolt(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DeathBolt : Item, ICommodity
    {
        ...
        public DeathBolt(Serial serial)
            : base(serial)
        {
        }
