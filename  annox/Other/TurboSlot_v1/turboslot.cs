 ...
 * 
 * Note: A player's luck can also affect odds, though it'll be random and reevaluted every 15 minutes
...
namespace Server.Items
{
    public class TurboSlot : Item
    {
        ...
        private void Profile(bool setuptheme, int count)
        {
            ...
            m_InUseBy.CloseGump(typeof(TurboSlotGump));
            m_InUseBy.SendGump(new TurboSlotGump(this, m_Symbols));
        }
#endif
        #region Theme Setup
    ...
    public class CasinoMembershipCard : Item   // Private Club "Jackpot Winners" Membership card
    {
        ...
        [Constructable]
        public CasinoMembershipCard() : base (0xE17)
        {
            this.Hue = 1150;
