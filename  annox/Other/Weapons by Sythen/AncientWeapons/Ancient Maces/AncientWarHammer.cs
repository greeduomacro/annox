...
{
	public class AncientWarHammer : WarHammer
	{
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient War Hammer of Might";
			...
			{
				Name = "Ancient War Hammer of Fire";
			...
			{
				Name = "Ancient War Hammer of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient War Hammer of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient War Hammer of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientWarHammer(Serial serial) : base( serial )
	 	{
	 	}
