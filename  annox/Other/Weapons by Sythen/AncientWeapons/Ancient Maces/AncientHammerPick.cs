...
{
	public class AncientHammerPick : HammerPick
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientHammerPick()
	 	{
	 	 	Name = "Ancient Hammer Pick";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Hammer Pick of Might";
			...
			{
				Name = "Ancient Hammer Pick of Fire";
			...
			{
				Name = "Ancient Hammer Pick of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Hammer Pick of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Hammer Pick of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientHammerPick(Serial serial) : base( serial )
	 	{
	 	}
