...
{
	public class AncientWarMace : WarMace
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientWarMace()
	 	{
	 	 	Name = "Ancient War Mace";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient War Mace of Might";
			...
			{
				Name = "Ancient War Mace of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient War Mace of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientWarMace(Serial serial) : base( serial )
	 	{
	 	}
