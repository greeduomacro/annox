...
{
	public class AncientBlackStaff : BlackStaff
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientBlackStaff()
	 	{
	 	 	Name = "Ancient Black Staff";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Black Staff of Might";
			...
			{
				Name = "Ancient Black Staff of Fire";
			...
			{
				Name = "Ancient Black Staff of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Black Staff of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Black Staff of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientBlackStaff(Serial serial) : base( serial )
	 	{
	 	}
