...
{
	public class AncientQuarterStaff : QuarterStaff
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientQuarterStaff()
	 	{
	 	 	Name = "Ancient Quarter Staff";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Quarter Staff of Might";
			...
			{
				Name = "Ancient Quarter Staff of Fire";
			...
			{
				Name = "Ancient Quarter Staff of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Quarter Staff of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Quarter Staff of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientQuarterStaff(Serial serial) : base( serial )
	 	{
	 	}
