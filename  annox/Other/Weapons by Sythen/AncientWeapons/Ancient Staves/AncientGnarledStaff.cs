...
{
	public class AncientGnarledStaff : GnarledStaff
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientGnarledStaff()
	 	{
	 	 	Name = "Ancient Gnarled Staff";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Gnarled Staff of Might";
			...
			{
				Name = "Ancient Gnarled Staff of Fire";
			...
			{
				Name = "Ancient Gnarled Staff of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Gnarled Staff of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Gnarled Staff of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientGnarledStaff(Serial serial) : base( serial )
	 	{
	 	}
