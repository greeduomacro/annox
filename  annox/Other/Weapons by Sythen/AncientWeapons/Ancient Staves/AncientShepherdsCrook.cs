...
{
	public class AncientShepherdsCrook : ShepherdsCrook
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientShepherdsCrook()
	 	{
	 	 	Name = "Ancient Shepherd's Crook";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Shepherd's Crook of Might";
			...
			{
				Name = "Ancient Shepherd's Crook of Fire";
			...
			{
				Name = "Ancient Shepherd's Crook of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Shepherd's Crook of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Shepherd's Crook of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientShepherdsCrook(Serial serial) : base( serial )
	 	{
	 	}
