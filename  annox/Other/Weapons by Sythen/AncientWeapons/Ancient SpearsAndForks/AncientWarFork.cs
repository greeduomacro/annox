...
{
	public class AncientWarFork : WarFork
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientWarFork()
	 	{
	 	 	Name = "Ancient War Fork";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient War Fork of Might";
			...
			{
				Name = "Ancient War Fork of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient War Fork of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientWarFork(Serial serial) : base( serial )
	 	{
	 	}
