...
{
	public class AncientDoubleBladedStaff : DoubleBladedStaff
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientDoubleBladedStaff()
	 	{
	 	 	Name = "Ancient Double Bladed Staff";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Double Bladed Staff of Might";
			...
			{
				Name = "Ancient Double Bladed Staff of Fire";
			...
			{
				Name = "Ancient Double Bladed Staff of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Double Bladed Staff of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Double Bladed Staff of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientDoubleBladedStaff(Serial serial) : base( serial )
	 	{
	 	}
