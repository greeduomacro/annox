...
{
	public class AncientBladedStaff : BladedStaff
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientBladedStaff()
	 	{
	 	 	Name = "Ancient Bladed Staff";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Bladed Staff of Might";
			...
			{
				Name = "Ancient Bladed Staff of Fire";
			...
			{
				Name = "Ancient Bladed Staff of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Bladed Staff of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Bladed Staff of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientBladedStaff(Serial serial) : base( serial )
	 	{
	 	}
