...
{
	public class AncientPitchfork : Pitchfork
	{
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Pitchfork of Might";
			...
			{
				Name = "Ancient Pitchfork of Fire";
			...
			{
				Name = "Ancient Pitchfork of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Pitchfork of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientPitchfork(Serial serial) : base( serial )
	 	{
	 	}
