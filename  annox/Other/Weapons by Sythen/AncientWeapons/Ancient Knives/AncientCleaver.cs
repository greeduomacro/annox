...
{
	public class AncientCleaver : Cleaver
	{
		...
		public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.InfectiousStrike; } }
	 	...
	 	[Constructable]
	 	public AncientCleaver()
	 	{
	 	 	Name = "Ancient Cleaver";
		...
		{								
			...
			{
				Name = "Ancient Cleaver of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Cleaver of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientCleaver(Serial serial) : base( serial )
	 	{
	 	}
