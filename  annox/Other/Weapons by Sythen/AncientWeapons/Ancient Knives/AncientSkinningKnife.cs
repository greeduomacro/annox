...
{
	public class AncientSkinningKnife : SkinningKnife
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientSkinningKnife()
	 	{
	 	 	Name = "Ancient Skinning Knife";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Skinning Knife of Might";
			...
			{
				Name = "Ancient Skinning Knife of Fire";
			...
			{
				Name = "Ancient Skinning Knife of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Skinning Knife of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Skinning Knife of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientSkinningKnife(Serial serial) : base( serial )
	 	{
	 	}
