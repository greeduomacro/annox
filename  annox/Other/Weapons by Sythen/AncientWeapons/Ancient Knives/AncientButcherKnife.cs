...
{
	public class AncientButcherKnife : ButcherKnife
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientButcherKnife()
	 	{
	 	 	Name = "Ancient Butcher Knife";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Butcher Knife of Might";
			...
			{
				Name = "Ancient Butcher Knife of Fire";
			...
			{
				Name = "Ancient Butcher Knife of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Butcher Knife of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Butcher Knife of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientButcherKnife(Serial serial) : base( serial )
	 	{
	 	}
