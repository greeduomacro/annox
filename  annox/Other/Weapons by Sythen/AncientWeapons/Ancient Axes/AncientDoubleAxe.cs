...
{
	public class AncientDoubleAxe : DoubleAxe
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientDoubleAxe()
	 	{
	 	 	Name = "Ancient Double Axe";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Double Axe of Might";
			...
			{
				Name = "Ancient Double Axe of Fire";
			...
			{
				Name = "Ancient Double Axe of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Double Axe of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Double Axe of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientDoubleAxe(Serial serial) : base( serial )
	 	{
	 	}
