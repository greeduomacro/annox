...
{
	public class AncientLargeBattleAxe : LargeBattleAxe
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientLargeBattleAxe()
	 	{
	 	 	Name = "Ancient Large Battle Axe";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Large Battle Axe of Might";
			...
			{
				Name = "Ancient Large Battle Axe of Fire";
			...
			{
				Name = "Ancient Large Battle Axe of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Large Battle Axe of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Large Battle Axe of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientLargeBattleAxe(Serial serial) : base( serial )
	 	{
	 	}
