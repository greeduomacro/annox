...
{
	public class AncientExecutionersAxe : ExecutionersAxe
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientExecutionersAxe()
	 	{
	 	 	Name = "Ancient Executioner's Axe";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Executioner's Axe of Might";
			...
			{
				Name = "Ancient Executioner's Axe of Fire";
			...
			{
				Name = "Ancient Executioner's Axe of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Executioner's Axe of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Executioner's Axe of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientExecutionersAxe(Serial serial) : base( serial )
	 	{
	 	}
