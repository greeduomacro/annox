...
{
	public class AncientTwoHandedAxe : TwoHandedAxe
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientTwoHandedAxe()
	 	{
	 	 	Name = "Ancient Two Handed Axe";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Two Handed Axe of Might";
			...
			{
				Name = "Ancient Two Handed Axe of Fire";
			...
			{
				Name = "Ancient Two Handed Axe of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Two Handed Axe of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Two Handed Axe of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientTwoHandedAxe(Serial serial) : base( serial )
	 	{
	 	}
