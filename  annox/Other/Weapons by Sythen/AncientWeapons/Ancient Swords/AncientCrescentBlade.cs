...
{
	public class AncientCrescentBlade : CrescentBlade
	{
		...
		public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.MortalStrike; } }
	 	...
	 	[Constructable]
	 	public AncientCrescentBlade()
	 	{
	 	 	Name = "Ancient Crescent Blade";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Crescent Blade of Might";
			...
			{
				Name = "Ancient Crescent Blade of Fire";
			...
			{
				Name = "Ancient Crescent Blade of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Crescent Blade of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Crescent Blade of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientCrescentBlade(Serial serial) : base( serial )
	 	{
	 	}
