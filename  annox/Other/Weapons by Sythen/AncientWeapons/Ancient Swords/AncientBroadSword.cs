...
{
	public class AncientBroadSword : Broadsword
	{
		...
		public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.ArmorIgnore; } }
	 	...
	 	[Constructable]
	 	public AncientBroadSword()
	 	{
	 	 	Name = "Ancient Broad Sword";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Broad Sword of Might";
			...
			{
				Name = "Ancient Broad Sword of Fire";
			...
			{
				Name = "Ancient Broad Sword of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Broad Sword of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Broad Sword of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientBroadSword(Serial serial) : base( serial )
	 	{
	 	}
