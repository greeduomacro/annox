...
{
	public class AncientVikingSword : VikingSword
	{
		...
		public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.ParalyzingBlow; } }
	 	...
	 	[Constructable]
	 	public AncientVikingSword()
	 	{
	 	 	Name = "Ancient Viking Sword";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Viking Sword of Might";
			...
			{
				Name = "Ancient Viking Sword of Fire";
			...
			{
				Name = "Ancient Viking Sword of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Viking Sword of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Viking Sword of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientVikingSword(Serial serial) : base( serial )
	 	{
	 	}
