...
{
	public class AncientLongSword : Longsword
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientLongSword()
	 	{
	 	 	Name = "Ancient Long Sword";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Long Sword of Might";
			...
			{
				Name = "Ancient Long Sword of Fire";
			...
			{
				Name = "Ancient Long Sword of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Long Sword of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Long Sword of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientLongSword(Serial serial) : base( serial )
	 	{
	 	}
