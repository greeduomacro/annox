...
{
	public class AncientBoneHarvester : BoneHarvester
	{
		...
		public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.MortalStrike; } }
	 	...
	 	[Constructable]
	 	public AncientBoneHarvester()
	 	{
	 	 	Name = "Ancient Bone Harvester";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Bone Harvester of Might";
			...
			{
				Name = "Ancient Bone Harvester of Fire";
			...
			{
				Name = "Ancient Bone Harvester of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Bone Harvester of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Bone Harvester of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientBoneHarvester(Serial serial) : base( serial )
	 	{
	 	}
