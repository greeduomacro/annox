...
{
	public class AncientScimitar : Scimitar
	{
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Scimitar of Might";
			...
			{
				Name = "Ancient Scimitar of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Scimitar of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientScimitar(Serial serial) : base( serial )
	 	{
	 	}
