...
{
	public class AncientHeavyCrossbow : HeavyCrossbow
	{
		...
		public override int InitMinHits{ get{ return 200; } }
	 	...
	 	[Constructable]
	 	public AncientHeavyCrossbow()
	 	{
	 	 	Name = "Ancient Heavy Crossbow";
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Heavy Crossbow of Might";
			...
			{
				Name = "Ancient Heavy Crossbow of Fire";
			...
			{
				Name = "Ancient Heavy Crossbow of Ice";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Heavy Crossbow of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Heavy Crossbow of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientHeavyCrossbow(Serial serial) : base( serial )
	 	{
	 	}
