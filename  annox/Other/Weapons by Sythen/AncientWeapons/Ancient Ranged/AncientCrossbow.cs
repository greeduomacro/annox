...
{
	public class AncientCrossbow : Crossbow
	{
		...
		{								
			...
			if ( mightforge != null )
			{
				Name = "Ancient Crossbow of Might";
			...
			{
				Name = "Ancient Crossbow of Energy";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
			...
			{
				Name = "Ancient Crossbow of Poison";
				WeaponAttributes.ResistPhysicalBonus = 0;
				WeaponAttributes.HitPhysicalArea = 0;
				WeaponAttributes.ResistFireBonus = 0;
				WeaponAttributes.HitFireArea = 0;
	 	...
	 	public AncientCrossbow(Serial serial) : base( serial )
	 	{
	 	}
