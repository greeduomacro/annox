...
namespace Server.Items
{
    public abstract class BaseMagicFood : Item
    {
        ...
        public BaseMagicFood(int itemID)
            : base(itemID)
        {
        }

        public BaseMagicFood(Serial serial)
            : base(serial)
        {
        }
    ...
    public class GloriousBeefRibs : BaseMagicFood
    {
        ...
        public GloriousBeefRibs(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ElixirOfSpeed : BaseMagicFood
    {
        ...
        public ElixirOfSpeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class PerfectSalad : BaseMagicFood
    {
        ...
        public PerfectSalad(Serial serial)
            : base(serial)
        {
        }
    ...
    public class MeditationSteak : BaseMagicFood
    {
        ...
        public MeditationSteak(Serial serial)
            : base(serial)
        {
        }
    ...
    public class MuffinsOfHealth : BaseMagicFood
    {
        ...
        public MuffinsOfHealth(Serial serial)
            : base(serial)
        {
        }
