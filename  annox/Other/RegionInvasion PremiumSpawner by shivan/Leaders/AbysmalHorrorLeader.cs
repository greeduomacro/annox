...
namespace Server.Mobiles
{
	...
	public class AbysmalHorrorLeader : RegionInvasionLeader
	{
		...
		[Constructable]
		public AbysmalHorrorLeader() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AbysmalHorrorLeader( Serial serial ) : base( serial )
		{
		}
