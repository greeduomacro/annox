...
{
	public class BestiaryBook : Item
	{
		...
		private string m_NameID = "Empty Book of Bestiary";
		...
		public BestiaryBook( Serial serial ) : base( serial )
		{
		}
 	...
 	public class BCaptureTarget : Target
 	{
 		...
 		protected override void OnTarget( Mobile from, object o )
 		{
 			if ( o is Mobile )
 			{
				...
				{
					from.SendMessage( 0x35, "That Creature is to strong to add to your bestiary!" );
 					return;
				}
				...
				if ( targ is BaseVendor )
 				...
 				{
 					from.PlaceInBackpack( new BestiaryBook(targ) );
...
namespace Server.Gumps
{
	public class BbookGump : Gump
	{
		...
		{
			BestiaryBook book = o as BestiaryBook;
			...
			AddImage(528, 92, 208);
			AddImage(421, 87, 93);
			AddLabel(435, 93, 0, @"Bestiary Stats");
