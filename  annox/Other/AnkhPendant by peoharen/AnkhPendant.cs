    ...
    public class AnkhPendant : BaseNecklace
    {
        ...
        public void GiveBonus(int chant, Mobile from)
        {
            if (VirtueEffect == chant)
                from.SendLocalizedMessage(1079544, m_ShrineMantra[chant]); // You already feel ~1_VIRTUE~ from your earlier contemplation of the virtues.
        ...
        public static readonly int[] m_ShrineWords = new int[]
		{
			1079535, // compassionate
			1079536, // just
			1079538, // charitable
			1079539, // honest
			1079540, // honorable
