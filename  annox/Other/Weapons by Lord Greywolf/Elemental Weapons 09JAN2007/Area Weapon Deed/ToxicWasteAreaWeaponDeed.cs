...
{
	public class ToxicWasteAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicWasteAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Waste Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
			AosElementDamages.Physical = 10;
			AosElementDamages.Energy = 10;
			AosElementDamages.Fire = 10;
			AosElementDamages.Cold = 10;
			AosElementDamages.Poison = 10;
		}
		...
		private class InternalGump : Gump
		{
			...
			private ToxicWasteAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicWasteAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Waste";
					weapon.AosElementDamages.Physical = 10;
					weapon.AosElementDamages.Energy = 10;
					weapon.AosElementDamages.Fire = 10;
					weapon.AosElementDamages.Cold = 10;
					weapon.AosElementDamages.Poison = 10;
		...
		public ToxicWasteAreaWeaponDeed( Serial serial ) : base( serial ) { }
