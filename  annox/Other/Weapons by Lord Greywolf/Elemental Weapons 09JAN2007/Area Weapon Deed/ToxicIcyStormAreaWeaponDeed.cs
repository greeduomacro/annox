...
{
	public class ToxicIcyStormAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicIcyStormAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Icy Storm Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicIcyStormAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicIcyStormAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Icy Storm";
		...
		public ToxicIcyStormAreaWeaponDeed( Serial serial ) : base( serial ) { }
