...
{
	public class ToxicLavaAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicLavaAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Lava Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicLavaAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicLavaAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Lava";
		...
		public ToxicLavaAreaWeaponDeed( Serial serial ) : base( serial ) { }
