...
{
	public class ToxicIceAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicIceAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Ice Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicIceAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicIceAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Ice";
		...
		public ToxicIceAreaWeaponDeed( Serial serial ) : base( serial ) { }
