...
{
	public class ElementalFuryAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ElementalFuryAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Elemental Fury Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
			AosElementDamages.Physical = 15;
			AosElementDamages.Energy = 15;
			AosElementDamages.Fire = 15;
			AosElementDamages.Cold = 15;
		}
		...
		private class InternalGump : Gump
		{
			...
			private ElementalFuryAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ElementalFuryAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Elemental Fury";
					weapon.AosElementDamages.Physical = 15;
					weapon.AosElementDamages.Energy = 15;
					weapon.AosElementDamages.Fire = 15;
					weapon.AosElementDamages.Cold = 15;
					weapon.WeaponAttributes.HitFireArea = 40;
					weapon.WeaponAttributes.HitColdArea = 40;
					weapon.WeaponAttributes.HitPhysicalArea = 40;
					weapon.WeaponAttributes.HitEnergyArea = 40;
		...
		public ElementalFuryAreaWeaponDeed( Serial serial ) : base( serial ) { }
