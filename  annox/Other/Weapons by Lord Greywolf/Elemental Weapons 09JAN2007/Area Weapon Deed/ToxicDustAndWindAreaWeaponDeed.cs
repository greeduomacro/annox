...
{
	public class ToxicDustAndWindAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicDustAndWindAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Dust & Wind Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicDustAndWindAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicDustAndWindAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
		...
		public ToxicDustAndWindAreaWeaponDeed( Serial serial ) : base( serial ) { }
