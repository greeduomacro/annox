...
{
	public class SmokeAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public SmokeAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Smoke Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private SmokeAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, SmokeAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Smoke";
		...
		public SmokeAreaWeaponDeed( Serial serial ) : base( serial ) { }
