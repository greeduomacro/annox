...
{
	public class ToxicTundraAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicTundraAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Tundra Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicTundraAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicTundraAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
		...
		public ToxicTundraAreaWeaponDeed( Serial serial ) : base( serial ) { }
