...
{
	public class ToxicStormAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicStormAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Storm Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicStormAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicStormAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Storm";
		...
		public ToxicStormAreaWeaponDeed( Serial serial ) : base( serial ) { }
