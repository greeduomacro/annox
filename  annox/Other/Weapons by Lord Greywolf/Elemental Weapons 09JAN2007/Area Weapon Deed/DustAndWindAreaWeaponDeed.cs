...
{
	public class DustAndWindAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public DustAndWindAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Dust & Wind Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
			AosElementDamages.Energy = 25;
		...
		private class InternalGump : Gump
		{
			...
			private DustAndWindAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, DustAndWindAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Dust & Wind";
		...
		public DustAndWindAreaWeaponDeed( Serial serial ) : base( serial ) { }
