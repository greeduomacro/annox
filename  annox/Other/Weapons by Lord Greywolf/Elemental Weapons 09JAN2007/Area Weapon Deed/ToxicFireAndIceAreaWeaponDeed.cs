...
{
	public class ToxicFireAndIceAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicFireAndIceAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Fire & Ice Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicFireAndIceAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicFireAndIceAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Fire & Ice";
					weapon.AosElementDamages.Fire = 20;
					weapon.AosElementDamages.Cold = 20;
					weapon.AosElementDamages.Poison = 20;
					weapon.WeaponAttributes.HitPoisonArea = 50;
					weapon.WeaponAttributes.HitFireArea = 50;
		...
		public ToxicFireAndIceAreaWeaponDeed( Serial serial ) : base( serial ) { }
