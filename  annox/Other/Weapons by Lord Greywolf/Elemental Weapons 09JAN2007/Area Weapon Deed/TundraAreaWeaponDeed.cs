...
{
	public class TundraAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public TundraAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Tundra Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private TundraAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, TundraAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Tundra";
		...
		public TundraAreaWeaponDeed( Serial serial ) : base( serial ) { }
