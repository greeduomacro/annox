...
{
	public class IcyStormAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public IcyStormAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Icy Storm Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private IcyStormAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, IcyStormAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
		...
		public IcyStormAreaWeaponDeed( Serial serial ) : base( serial ) { }
