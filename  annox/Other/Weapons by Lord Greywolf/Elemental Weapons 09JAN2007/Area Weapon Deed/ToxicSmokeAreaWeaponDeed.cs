...
{
	public class ToxicSmokeAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicSmokeAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Smoke Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicSmokeAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicSmokeAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Smoke";
		...
		public ToxicSmokeAreaWeaponDeed( Serial serial ) : base( serial ) { }
