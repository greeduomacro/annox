...
{
	public class LavaAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public LavaAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Lava Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private LavaAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, LavaAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Lava";
		...
		public LavaAreaWeaponDeed( Serial serial ) : base( serial ) { }
