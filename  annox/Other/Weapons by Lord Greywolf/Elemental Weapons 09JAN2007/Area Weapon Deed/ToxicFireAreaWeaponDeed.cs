...
{
	public class ToxicFireAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicFireAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Fire Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicFireAreaWeaponDeed m_Deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Fire";
		...
		public ToxicFireAreaWeaponDeed( Serial serial ) : base( serial ) { }
