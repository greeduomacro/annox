...
{
	public class ToxicEarthAreaWeaponDeed : BaseSword
	{
		[Constructable]
		public ToxicEarthAreaWeaponDeed() : base( 0x227B )
		{
			Name = "Toxic Earth Area Weapon Deed";
			Weight = 1.0;
			Hue = 2100;
		...
		private class InternalGump : Gump
		{
			...
			private ToxicEarthAreaWeaponDeed m_Deed;

			public InternalGump( Mobile from, ToxicEarthAreaWeaponDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( weapon != null )
				{
					weapon.Name = weapon.Name + " of Toxic Earth";
					weapon.AosElementDamages.Poison = 25;
					weapon.AosElementDamages.Physical = 25;
					weapon.WeaponAttributes.HitPoisonArea = 75;
					weapon.WeaponAttributes.HitPhysicalArea = 75;
		...
		public ToxicEarthAreaWeaponDeed( Serial serial ) : base( serial ) { }
