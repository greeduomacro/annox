...
{
	public class VenomScythe : Scythe
	{
		...
		{
			private VenomScythe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomScythe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomScythe( Serial serial ) : base( serial ) { }
