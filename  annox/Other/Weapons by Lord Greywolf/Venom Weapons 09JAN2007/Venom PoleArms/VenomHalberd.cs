...
{
	public class VenomHalberd : Halberd
	{
		...
		{
			private VenomHalberd i_Std;
			private int m_Charges;
			public PoisonTarget( VenomHalberd std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomHalberd( Serial serial ) : base( serial ) { }
