...
{
	public class VenomBardiche : Bardiche
	{
		...
		{
			private VenomBardiche i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBardiche std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBardiche( Serial serial ) : base( serial ) { }
