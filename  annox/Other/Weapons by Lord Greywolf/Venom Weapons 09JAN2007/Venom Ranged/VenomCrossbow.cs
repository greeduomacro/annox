...
{
	public class VenomCrossbow : Crossbow
	{
		...
		{
			private VenomCrossbow i_Std;
			private int m_Charges;
			public PoisonTarget( VenomCrossbow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomCrossbow( Serial serial ) : base( serial ) { }
