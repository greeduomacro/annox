...
{
	public class VenomCompositeBow : CompositeBow
	{
		...
		[Constructable]
		public VenomCompositeBow()
		{
			Name = "Venom Composite Bow";
		...
		{
			private VenomCompositeBow i_Std;
			private int m_Charges;
			public PoisonTarget( VenomCompositeBow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomCompositeBow( Serial serial ) : base( serial ) { }
