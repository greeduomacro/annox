...
namespace Server.Items
{
	public class VenomBow : Bow
	{
		...
		{
			private VenomBow i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBow( Serial serial ) : base( serial ) { }
