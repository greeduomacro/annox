...
{
	public class VenomHeavyCrossbow : HeavyCrossbow
	{
		...
		[Constructable]
		public VenomHeavyCrossbow()
		{
			Name = "Venom Heavy Crossbow";
		...
		{
			private VenomHeavyCrossbow i_Std;
			private int m_Charges;
			public PoisonTarget( VenomHeavyCrossbow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomHeavyCrossbow( Serial serial ) : base( serial ) { }
