...
{
	public class VenomDoubleBladedStaff : DoubleBladedStaff
	{
		...
		[Constructable]
		public VenomDoubleBladedStaff()
		{
			Name = "Venom Double Bladed Staff";
		...
		{
			private VenomDoubleBladedStaff i_Std;
			private int m_Charges;
			public PoisonTarget( VenomDoubleBladedStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomDoubleBladedStaff( Serial serial ) : base( serial ) { }
