...
{
	public class VenomPitchfork : Pitchfork
	{
		...
		[Constructable]
		public VenomPitchfork()
		{
			Name = "Venom Pitchfork";
		...
		{
			private VenomPitchfork i_Std;
			private int m_Charges;
			public PoisonTarget( VenomPitchfork std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomPitchfork( Serial serial ) : base( serial ) { }
