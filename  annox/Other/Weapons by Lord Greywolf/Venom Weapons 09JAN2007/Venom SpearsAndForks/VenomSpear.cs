...
namespace Server.Items
{
	public class VenomSpear : Spear
	{
		...
		{
			private VenomSpear i_Std;
			private int m_Charges;
			public PoisonTarget( VenomSpear std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomSpear( Serial serial ) : base( serial ) { }
