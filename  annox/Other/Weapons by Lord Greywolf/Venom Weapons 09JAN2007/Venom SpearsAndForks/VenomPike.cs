...
namespace Server.Items
{
	public class VenomPike : Pike
	{
		...
		{
			private VenomPike i_Std;
			private int m_Charges;
			public PoisonTarget( VenomPike std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomPike( Serial serial ) : base( serial ) { }
