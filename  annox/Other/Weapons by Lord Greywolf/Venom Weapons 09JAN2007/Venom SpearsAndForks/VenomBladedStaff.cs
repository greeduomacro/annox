...
{
	public class VenomBladedStaff : BladedStaff
	{
		...
		[Constructable]
		public VenomBladedStaff()
		{
			Name = "Venom Bladed Staff";
		...
		{
			private VenomBladedStaff i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBladedStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBladedStaff( Serial serial ) : base( serial ) { }
