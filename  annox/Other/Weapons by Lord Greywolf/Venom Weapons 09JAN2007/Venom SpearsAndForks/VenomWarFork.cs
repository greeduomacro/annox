...
{
	public class VenomWarFork : WarFork
	{
		...
		{
			private VenomWarFork i_Std;
			private int m_Charges;
			public PoisonTarget( VenomWarFork std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomWarFork( Serial serial ) : base( serial ) { }
