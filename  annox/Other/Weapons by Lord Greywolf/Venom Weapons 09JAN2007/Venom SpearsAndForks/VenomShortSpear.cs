...
{
	public class VenomShortSpear : ShortSpear
	{
		...
		[Constructable]
		public VenomShortSpear()
		{
			Name = "Venom Short Spear";
		...
		{
			private VenomShortSpear i_Std;
			private int m_Charges;
			public PoisonTarget( VenomShortSpear std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomShortSpear( Serial serial ) : base( serial ) { }
