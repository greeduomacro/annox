...
{
	public class VenomBroadSword : Broadsword
	{
		...
		[Constructable]
		public VenomBroadSword()
		{
			Name = "Venom Broad Sword";
		...
		{
			private VenomBroadSword i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBroadSword std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBroadSword( Serial serial ) : base( serial ) { }
