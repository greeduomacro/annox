...
namespace Server.Items
{
	public class VenomKryss : Kryss
	{
		...
		{
			private VenomKryss i_Std;
			private int m_Charges;
			public PoisonTarget( VenomKryss std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomKryss( Serial serial ) : base( serial ) { }
