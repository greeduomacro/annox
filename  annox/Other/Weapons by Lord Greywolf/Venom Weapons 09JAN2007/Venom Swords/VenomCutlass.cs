...
{
	public class VenomCutlass : Cutlass
	{
		...
		{
			private VenomCutlass i_Std;
			private int m_Charges;
			public PoisonTarget( VenomCutlass std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomCutlass( Serial serial ) : base( serial ) { }
