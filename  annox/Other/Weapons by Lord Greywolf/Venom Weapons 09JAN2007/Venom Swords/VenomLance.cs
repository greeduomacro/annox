...
namespace Server.Items
{
	public class VenomLance : Lance
	{
		...
		{
			private VenomLance i_Std;
			private int m_Charges;
			public PoisonTarget( VenomLance std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomLance( Serial serial ) : base( serial ) { }
