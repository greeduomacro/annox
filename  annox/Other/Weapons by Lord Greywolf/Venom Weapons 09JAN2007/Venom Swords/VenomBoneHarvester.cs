...
{
	public class VenomBoneHarvester : BoneHarvester
	{
		...
		[Constructable]
		public VenomBoneHarvester()
		{
			Name = "Venom Bone Harvester";
		...
		{
			private VenomBoneHarvester i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBoneHarvester std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBoneHarvester( Serial serial ) : base( serial ) { }
