...
{
	public class VenomVikingSword : VikingSword
	{
		...
		[Constructable]
		public VenomVikingSword()
		{
			Name = "Venom Viking Sword";
		...
		{
			private VenomVikingSword i_Std;
			private int m_Charges;
			public PoisonTarget( VenomVikingSword std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomVikingSword( Serial serial ) : base( serial ) { }
