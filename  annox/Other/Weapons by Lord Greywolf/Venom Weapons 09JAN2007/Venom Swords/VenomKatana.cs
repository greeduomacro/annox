...
{
	public class VenomKatana : Katana
	{
		...
		{
			private VenomKatana i_Std;
			private int m_Charges;
			public PoisonTarget( VenomKatana std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomKatana( Serial serial ) : base( serial ) { }
