...
{
	public class VenomLongSword : Longsword
	{
		...
		[Constructable]
		public VenomLongSword()
		{
			Name = "Venom Long Sword";
		...
		{
			private VenomLongSword i_Std;
			private int m_Charges;
			public PoisonTarget( VenomLongSword std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomLongSword( Serial serial ) : base( serial ) { }
