...
{
	public class VenomCrescentBlade : CrescentBlade
	{
		...
		[Constructable]
		public VenomCrescentBlade()
		{
			Name = "Venom Crescent Blade";
		...
		{
			private VenomCrescentBlade i_Std;
			private int m_Charges;
			public PoisonTarget( VenomCrescentBlade std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomCrescentBlade( Serial serial ) : base( serial ) { }
