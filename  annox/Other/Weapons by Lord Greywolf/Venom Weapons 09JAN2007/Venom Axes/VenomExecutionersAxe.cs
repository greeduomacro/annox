...
{
	public class VenomExecutionersAxe : ExecutionersAxe
	{
		...
		[Constructable]
		public VenomExecutionersAxe()
		{
			Name = "Venom Executioner's Axe";
		...
		{
			private VenomExecutionersAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomExecutionersAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomExecutionersAxe( Serial serial ) : base( serial ) { }
