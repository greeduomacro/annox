...
{
	public class VenomLargeBattleAxe : LargeBattleAxe
	{
		...
		[Constructable]
		public VenomLargeBattleAxe()
		{
			Name = "Venom Large Battle Axe";
		...
		{
			private VenomLargeBattleAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomLargeBattleAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomLargeBattleAxe( Serial serial ) : base( serial ) { }
