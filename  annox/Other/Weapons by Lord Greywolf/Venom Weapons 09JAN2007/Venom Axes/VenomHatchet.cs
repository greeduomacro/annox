...
{
	public class VenomHatchet : Hatchet
	{
		...
		{
			private VenomHatchet i_Std;
			private int m_Charges;
			public PoisonTarget( VenomHatchet std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomHatchet( Serial serial ) : base( serial ) { }
