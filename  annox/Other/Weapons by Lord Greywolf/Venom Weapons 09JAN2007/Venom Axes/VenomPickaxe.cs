...
{
	public class VenomPickaxe : Pickaxe
	{
		...
		{
			private VenomPickaxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomPickaxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomPickaxe( Serial serial ) : base( serial ) { }
