...
namespace Server.Items
{
	public class VenomAxe : Axe
	{
		...
		{
			private VenomAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomAxe( Serial serial ) : base( serial ) { }
