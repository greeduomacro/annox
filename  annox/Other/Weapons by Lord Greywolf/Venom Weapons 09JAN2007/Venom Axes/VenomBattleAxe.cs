...
{
	public class VenomBattleAxe : BattleAxe
	{
		...
		[Constructable]
		public VenomBattleAxe()
		{
			Name = "Venom Battle Axe";
		...
		{
			private VenomBattleAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBattleAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBattleAxe( Serial serial ) : base( serial ) { }
