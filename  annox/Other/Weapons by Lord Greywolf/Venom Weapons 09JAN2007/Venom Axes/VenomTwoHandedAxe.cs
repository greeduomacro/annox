...
{
	public class VenomTwoHandedAxe : TwoHandedAxe
	{
		...
		[Constructable]
		public VenomTwoHandedAxe()
		{
			Name = "Venom Two Handed Axe";
		...
		{
			private VenomTwoHandedAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomTwoHandedAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomTwoHandedAxe( Serial serial ) : base( serial ) { }
