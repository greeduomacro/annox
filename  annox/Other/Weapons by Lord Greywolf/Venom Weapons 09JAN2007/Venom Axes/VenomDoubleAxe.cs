...
{
	public class VenomDoubleAxe : DoubleAxe
	{
		...
		[Constructable]
		public VenomDoubleAxe()
		{
			Name = "Venom Double Axe";
		...
		{
			private VenomDoubleAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomDoubleAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomDoubleAxe( Serial serial ) : base( serial ) { }
