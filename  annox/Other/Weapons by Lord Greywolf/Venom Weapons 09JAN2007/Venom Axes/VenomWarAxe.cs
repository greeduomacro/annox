...
{
	public class VenomWarAxe : WarAxe
	{
		...
		{
			private VenomWarAxe i_Std;
			private int m_Charges;
			public PoisonTarget( VenomWarAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomWarAxe( Serial serial ) : base( serial ) { }
