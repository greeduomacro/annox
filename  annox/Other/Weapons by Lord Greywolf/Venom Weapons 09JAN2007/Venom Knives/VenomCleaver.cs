...
{
	public class VenomCleaver : Cleaver
	{
		...
		{
			private VenomCleaver i_Std;
			private int m_Charges;
			public PoisonTarget( VenomCleaver std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomCleaver( Serial serial ) : base( serial ) { }
