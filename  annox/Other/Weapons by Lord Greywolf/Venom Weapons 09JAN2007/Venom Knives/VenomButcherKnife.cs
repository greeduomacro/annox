...
{
	public class VenomButcherKnife : ButcherKnife
	{
		...
		[Constructable]
		public VenomButcherKnife()
		{
			Name = "Venom Butcher Knife";
		...
		{
			private VenomButcherKnife i_Std;
			private int m_Charges;
			public PoisonTarget( VenomButcherKnife std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomButcherKnife( Serial serial ) : base( serial ) { }
