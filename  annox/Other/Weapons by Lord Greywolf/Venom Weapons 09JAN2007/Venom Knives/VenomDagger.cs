...
{
	public class VenomDagger : Dagger
	{
		...
		{
			private VenomDagger i_Std;
			private int m_Charges;
			public PoisonTarget( VenomDagger std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomDagger( Serial serial ) : base( serial ) { }
