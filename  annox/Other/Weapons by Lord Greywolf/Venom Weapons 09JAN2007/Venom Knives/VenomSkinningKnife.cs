...
{
	public class VenomSkinningKnife : SkinningKnife
	{
		...
		[Constructable]
		public VenomSkinningKnife()
		{
			Name = "Venom Skinning Knife";
		...
		{
			private VenomSkinningKnife i_Std;
			private int m_Charges;
			public PoisonTarget( VenomSkinningKnife std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomSkinningKnife( Serial serial ) : base( serial ) { }
