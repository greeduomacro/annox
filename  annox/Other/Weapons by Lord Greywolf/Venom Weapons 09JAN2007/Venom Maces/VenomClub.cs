...
namespace Server.Items
{
	public class VenomClub : Club
	{
		...
		{
			private VenomClub i_Std;
			private int m_Charges;
			public PoisonTarget( VenomClub std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomClub( Serial serial ) : base( serial ) { }
