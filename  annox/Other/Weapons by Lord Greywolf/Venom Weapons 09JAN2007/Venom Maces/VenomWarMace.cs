...
{
	public class VenomWarMace : WarMace
	{
		...
		{
			private VenomWarMace i_Std;
			private int m_Charges;
			public PoisonTarget( VenomWarMace std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomWarMace( Serial serial ) : base( serial ) { }
