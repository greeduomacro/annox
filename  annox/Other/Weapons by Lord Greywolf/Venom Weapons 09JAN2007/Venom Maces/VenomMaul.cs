...
namespace Server.Items
{
	public class VenomMaul : Maul
	{
		...
		{
			private VenomMaul i_Std;
			private int m_Charges;
			public PoisonTarget( VenomMaul std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomMaul( Serial serial ) : base( serial ) { }
