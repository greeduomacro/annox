...
{
	public class VenomWarHammer : WarHammer
	{
		...
		[Constructable]
		public VenomWarHammer()
		{
			Name = "Venom War Hammer";
		...
		{
			private VenomWarHammer i_Std;
			private int m_Charges;
			public PoisonTarget( VenomWarHammer std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomWarHammer( Serial serial ) : base( serial ) { }
