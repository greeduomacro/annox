...
{
	public class VenomHammerPick : HammerPick
	{
		...
		[Constructable]
		public VenomHammerPick()
		{
			Name = "Venom Hammer Pick";
		...
		{
			private VenomHammerPick i_Std;
			private int m_Charges;
			public PoisonTarget( VenomHammerPick std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomHammerPick( Serial serial ) : base( serial ) { }
