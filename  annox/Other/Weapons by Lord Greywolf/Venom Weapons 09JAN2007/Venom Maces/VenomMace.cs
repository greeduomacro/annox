...
namespace Server.Items
{
	public class VenomMace : Mace
	{
		...
		{
			private VenomMace i_Std;
			private int m_Charges;
			public PoisonTarget( VenomMace std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomMace( Serial serial ) : base( serial ) { }
