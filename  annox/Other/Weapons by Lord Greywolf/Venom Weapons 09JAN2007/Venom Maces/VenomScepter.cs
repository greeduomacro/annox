...
{
	public class VenomScepter : Scepter
	{
		...
		{
			private VenomScepter i_Std;
			private int m_Charges;
			public PoisonTarget( VenomScepter std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomScepter( Serial serial ) : base( serial ) { }
