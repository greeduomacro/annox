...
{
	public class VenomQuarterStaff : QuarterStaff
	{
		...
		[Constructable]
		public VenomQuarterStaff()
		{
			Name = "Venom Quarter Staff";
		...
		{
			private VenomQuarterStaff i_Std;
			private int m_Charges;
			public PoisonTarget( VenomQuarterStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomQuarterStaff( Serial serial ) : base( serial ) { }
