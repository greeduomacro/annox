...
{
	public class VenomGnarledStaff : GnarledStaff
	{
		...
		[Constructable]
		public VenomGnarledStaff()
		{
			Name = "Venom Gnarled Staff";
		...
		{
			private VenomGnarledStaff i_Std;
			private int m_Charges;
			public PoisonTarget( VenomGnarledStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomGnarledStaff( Serial serial ) : base( serial ) { }
