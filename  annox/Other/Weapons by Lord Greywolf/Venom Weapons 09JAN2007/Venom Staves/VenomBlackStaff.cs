...
{
	public class VenomBlackStaff : BlackStaff
	{
		...
		[Constructable]
		public VenomBlackStaff()
		{
			Name = "Venom Black Staff";
		...
		{
			private VenomBlackStaff i_Std;
			private int m_Charges;
			public PoisonTarget( VenomBlackStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomBlackStaff( Serial serial ) : base( serial ) { }
