...
{
	public class VenomShepherdsCrook : ShepherdsCrook
	{
		...
		[Constructable]
		public VenomShepherdsCrook()
		{
			Name = "Venom Shepherd's Crook";
		...
		{
			private VenomShepherdsCrook i_Std;
			private int m_Charges;
			public PoisonTarget( VenomShepherdsCrook std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public VenomShepherdsCrook( Serial serial ) : base( serial ) { }
