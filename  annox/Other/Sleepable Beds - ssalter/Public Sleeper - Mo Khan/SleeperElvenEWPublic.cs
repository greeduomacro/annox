...
namespace Server.Items
{
    ...
    public class SleeperElvenEWPublic : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperElvenEWPublicDeed();
            }
        }

        public SleeperElvenEWPublic(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SleeperElvenEWPiecePublic : AddonComponent
    {
        ...
        public SleeperElvenEWPiecePublic(SleeperElvenEWPublic sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public SleeperElvenEWPiecePublic(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SleeperElvenEWPublicDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperElvenEWPublic();
            }
        }

        [Constructable]
        public SleeperElvenEWPublicDeed()
        {
            Name = "a sleepable bed facing east deed.";
        }

        public SleeperElvenEWPublicDeed(Serial serial)
            : base(serial)
        {
        }
