//12OCT2006 Updated to work with SVN r92 (see below)
//Errors:
// + Custom/Other/Sleepable Beds-ssalter/sleepablebeds/SleeperBedBody.cs:
//    CS0506: Line 171: 'Server.Items.SleeperBedBody.SendInfoTo(Server.Network.NetState)':
//     cannot override inherited member 'Server.Item.SendInfoTo(Server.Network.NetState)' 
...
namespace Server.Items
{
    public class SleeperBedBody : Container
    {
        ...
        [Constructable]
        public SleeperBedBody(Mobile owner, bool blessed)
            : this(owner, blessed, true)
        {
        }

        [Constructable]
        public SleeperBedBody(Mobile owner, bool blessed, bool isSpell)
            : base(0x2006)
        {
        ...
        public SleeperBedBody(Serial serial)
            : base(serial)
        {
        }

        //12OCT2006 Updated to work with SVN r92 *** START ***
        ...
        //12OCT2006 Updated to work with SVN r92 *** END ***
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(Mobile m, Item body)
