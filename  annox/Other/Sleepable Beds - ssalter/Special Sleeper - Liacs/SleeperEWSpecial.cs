...
namespace Server.Items
{
	...
	public class SleeperEWCleanableAddon: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperEWCleanableAddonDeed ();
            }
        }

		public SleeperEWCleanableAddon( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperEWCleanableAddon( ) 
		{
			Visible = true;
			Name = "Sleeper";
			AddComponent( new SleeperEWCleanablePiece(this, 0xA7D), 0, 0, 0 );
			AddComponent( new SleeperEWCleanablePiece(this, 0xA7C), 0, 1, 0 );
			AddComponent( new SleeperEWCleanablePiece(this, 0xA79), 1, 0, 0 );
			AddComponent( new SleeperEWCleanablePiece(this, 0xA78), 1, 1, 0 );
		}
		
		private SleeperEWCleanableAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperEWCleanableAddon Sleeper
		{
	...
	public class SleeperEWCleanablePiece : AddonComponent
	{
		...
		public SleeperEWCleanablePiece( Serial serial ) : base( serial )
		{
		}
   ...
   public class SleeperEWCleanableAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperEWCleanableAddon ();
            }
        }

        [Constructable]
        public SleeperEWCleanableAddonDeed ()
        {
            Name = "a large sleepable bed facing east deed.";
        }

        public SleeperEWCleanableAddonDeed ( Serial serial )
            : base ( serial )
        {
        }
