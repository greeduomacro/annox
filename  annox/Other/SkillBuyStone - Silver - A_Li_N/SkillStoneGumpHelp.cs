...
namespace Server.Items
{
	public class SkillStoneGumpHelp : Gump
	{
		...
		public SkillStoneGumpHelp( SkillBuyStone stone, Mobile from ) : base( 180, 30 )
		{
			...
			AddLabel( 177, 245, 53, "%" );
			AddLabel( 177, 290, 53, "Silver" );
			AddLabel( 177, 380, 43, "Silver Cost per " + "" + m_Stone.SkillIncrease + "%:" );
			...
			AddLabel( 248, 290, 38, "- Click a button under this to purchase the skill for Silver" );
			AddLabel( 310, 380, 38, "- Displays Price in Silver" );
