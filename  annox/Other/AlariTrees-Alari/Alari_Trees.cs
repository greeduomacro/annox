// Trees.cs by Alari (alarihyena@gmail.com)
// Includes:
//  CederTree
//  
//  
...
namespace Server.Items
{
    /*
    *******************************************************
        public class GenericTree : BaseAddon
        {
            [Constructable]
            public GenericTree()
            {
                // trunk
                AddComponent( new AddonComponent ( Utility.RandomList( ####, #### ) ), 0, 0, 0 );
                // leaves
                AddComponent( new AddonComponent ( Utility.RandomList( ####, #### ) ), 0, 0, 0 );
            }

            public GenericTree( Serial serial ) : base( serial )
            {
            }
    ...
    */
    ...
    public class CedarTree : BaseAddon
    {
        ...
        public CedarTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class CederTree : BaseAddon
    {
        ...
        public CederTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class CypressTree : BaseAddon
    {
        ...
        public CypressTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SaplingTree : BaseAddon
    {
        ...
        public SaplingTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SmallPalmTree : BaseAddon
    {
        ...
        public SmallPalmTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class TuscanyPineTree : BaseAddon
    {
        ...
        public TuscanyPineTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class WalnutTree : BaseAddon
    {
        ...
        public WalnutTree(Serial serial)
            : base(serial)
        {
        }
    ...
    public class WillowTree : BaseAddon
    {
        ...
        public WillowTree(Serial serial)
            : base(serial)
        {
        }
