//http://www.runuo.com/forums/custom-script-releases/85218-runuo-2-0-svn-pet-rezzing-vets.html
...
namespace Server.Mobiles
{
    public class RezzingVet : BaseVendor
    {
        ...
        public override void InitSBInfo()
        {
            ...
            m_SBInfos.Add(new PetBondDeed());

        }

        public RezzingVet(Serial serial)
            : base(serial)
        {
        }
