//http://www.runuo.com/forums/custom-script-releases/73093-runuo-2-0-rc1-pet-resurrection-stone.html
...
namespace Server.Items
{
    public class PetRezStone : Item
    {
        ...
        public PetRezStone(Serial serial)
            : base(serial)
        {
        }
    ...
    public class PetRezStoneTarget : Target
    {
        ...
        public PetRezStoneTarget(PetRezStone stone)
