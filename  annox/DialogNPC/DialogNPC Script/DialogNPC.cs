//modified the path to where things are stored.
//Z:\Scripts\Custom\DialogNPC\DialogAnNox
//14JUL2006 Updated for RunUOv2r65
using System;
...
namespace Arya.DialogEditor
{
	...
	public class DialogNPC : BaseCreature
	{
		...
		/// </summary>
        private static string m_XmlFolder = @"Scripts\Custom\DialogNPC\DialogAnNox";
