...
namespace Server.Mobiles
{
	...
	public class LinkedMongbat : BaseLinkedCreature
	{
		//NOTE: this will only link with other LinkedMongbats within its vicinity
		...
		[Constructable]
		public LinkedMongbat() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a swarm mongbat";
			Body = 39;
			BaseSoundID = 422;
		...
		public LinkedMongbat( Serial serial ) : base( serial )
		{
		}
