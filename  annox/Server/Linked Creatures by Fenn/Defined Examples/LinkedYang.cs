...
namespace Server.Mobiles
{
	...
	*/
	...
	[CorpseName( "a yang corpse" )]
	public class LinkedYang : BaseLinkedCreature
	{
		...
		[Constructable]
		public LinkedYang() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Yang";
			Body = 247;
			BaseSoundID = 0x372;
		...
		public LinkedYang( Serial serial ) : base( serial )
		{
		}
