...
{ 
	...
	{ 
		...
		[Constructable]
		public ChallengeStone() : this( new Point3D( 0, 0, 0 ), new Point3D( 0, 0, 0 ), new Point3D( 0, 0, 0 ), new Point3D( 0, 0, 0 ), null, null, false )
		{
		}

		[Constructable]
		public ChallengeStone( Point3D challengerpointDest, Point3D opponentpointDest, Point3D challengerexit, Point3D opponentexit, Map mapDest, Map mapOrig,bool creatures ) : base( 0xED4 )
		{
			Movable = false; 
			Hue = 0; 
