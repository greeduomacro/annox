...
namespace Server.Mobiles
{
	...
	public class AParrot : BaseCreature
	{
		[Constructable]
		public AParrot() : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			this.Body = 282;   // 831; for 3D
		...
		public AParrot(Serial serial) : base(serial)
		{
		}
