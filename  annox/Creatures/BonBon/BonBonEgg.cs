...
{
    public class BonBonEgg : Item, ICarvable
    {
        private BonBonTimer m_Timer;
        ...
        {
            Movable = false;
            Name = "an Explosive BonBon Egg";

            m_Timer = new BonBonTimer(this);
            m_Timer.Start();
        }
        ...
        public BonBonEgg(Serial serial)
            : base(serial)
        {
        }
        ...
        private class BonBonTimer : Timer
        {
            private Item m_Item;

            public BonBonTimer(Item item)
                : base(TimeSpan.FromSeconds(Utility.RandomMinMax(2, 6)))
            {
