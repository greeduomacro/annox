...
{ 
        [CorpseName( "a ridable drake corpse" )] 
        public class RDrake : BaseMount 
        { 
                [Constructable] 
                public RDrake() : this( "a drake" ) 
                { 
                } 

                [Constructable] 
                public RDrake ( string name ) : base( name, 0x3C, 0x3f0e, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
                { 
                        Name = "a drake";
