...
{
    public class ElvenWeaponSmith : BaseVendor
    {
        private ArrayList m_SBInfos = new ArrayList();
        protected override ArrayList SBInfos { get { return m_SBInfos; } }

        [Constructable]
        public ElvenWeaponSmith()
            : base("the Elven Weaponsmith")
        {
        ...
        {
            m_SBInfos.Add(new SBElvenWeaponSmith());
        }
        ...
        public ElvenWeaponSmith(Serial serial)
            : base(serial)
        {
        }
