...
namespace Server.Gumps
{
    public class SIMGumpList : Gump
    {
        ...
        {
            //remove the following two lines if your useing Knives Chat System
            CommandSystem.Register("Chat", AccessLevel.Player, new CommandEventHandler(SIM_OnCommand));
            CommandSystem.Register("C", AccessLevel.Player, new CommandEventHandler(SIM_OnCommand));
            CommandSystem.Register("SIM", AccessLevel.Player, new CommandEventHandler(SIM_OnCommand));
