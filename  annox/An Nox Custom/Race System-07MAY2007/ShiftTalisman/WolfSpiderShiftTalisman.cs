...
{
    public class WolfSpiderShiftTalisman : Item
    {
        [Constructable]
        public WolfSpiderShiftTalisman()
            : base(0x2F59)
        {
            Movable = true;
            Hue = 1265;
            Name = "A WolfSpider Shapeshift Talisman";
        ...
        public WolfSpiderShiftTalisman(Serial serial)
            : base(serial)
        {
        }
