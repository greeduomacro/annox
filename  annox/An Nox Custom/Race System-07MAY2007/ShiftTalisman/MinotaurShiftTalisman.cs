...
{
    public class MinotaurShiftTalisman : Item
    {
        [Constructable]
        public MinotaurShiftTalisman()
            : base(0x2F59)
        {
            Movable = true;
            Hue = 748;
            Name = "A Minotaur Shapeshift Talisman";
        ...
        public MinotaurShiftTalisman(Serial serial)
            : base(serial)
        {
        }
