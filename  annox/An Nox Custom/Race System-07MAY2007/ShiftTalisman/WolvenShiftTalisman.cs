...
{
    public class WolvenShiftTalisman : Item
    {
        [Constructable]
        public WolvenShiftTalisman()
            : base(0x2F59)
        {
            Movable = true;
            Hue = 1001;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        from.BodyMod = 0x0;
                        from.HueMod = 1150;//make grey or gold.
        ...
        public WolvenShiftTalisman(Serial serial)
            : base(serial)
        {
        }
