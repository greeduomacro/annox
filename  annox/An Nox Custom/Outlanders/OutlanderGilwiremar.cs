...
{
    [CorpseName("Gilwiremar's corpse")] // Why is this 'juka' and warriors 'jukan' ? :-(
    public class Gilwiremar : BaseCreature
    {
        [Constructable]
        public Gilwiremar()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "Gilwiremar the Outlander";
            Body = 772;
            Team = 2;
        ...
        public Gilwiremar(Serial serial)
            : base(serial)
        {
        }
