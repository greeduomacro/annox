...
namespace Server
{
    public class RandomTOTDXMLReader
    {
        ...
        public RandomTOTDXMLReader(string type, XmlElement xml)
        {
            m_Type = type;
        ...
        public static RandomTOTDXMLReader GetRandomTOTDXMLReader(string type)
        {
            return (RandomTOTDXMLReader)m_Table[type];
        }

        public static string RandomName(string type)
        {
            RandomTOTDXMLReader list = GetRandomTOTDXMLReader(type);
        ...
        static RandomTOTDXMLReader()
        {
            // + Custom/An Nox Custom/TalkingTownFolks/RandomTOTDXMLReader.cs:
            ...
            string filePath = Path.Combine(Core.BaseDirectory, "Data/RandomTOTD.xml");
        ...
        private static void Load(string filePath)
        {
            ...
            foreach (XmlElement element in root.GetElementsByTagName("namelist"))
            {
                ...
                try
                {
                    RandomTOTDXMLReader list = new RandomTOTDXMLReader(type, element);
