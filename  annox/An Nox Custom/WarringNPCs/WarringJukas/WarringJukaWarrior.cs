...
namespace Server.Mobiles
{
	...
	public class WarringJukaWarrior : BaseCreature
	{
		[Constructable]
		public WarringJukaWarrior() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a juka warrior";
			Body = 764;
            Team = 2;
		...
		public WarringJukaWarrior( Serial serial ) : base( serial )
		{
		}
