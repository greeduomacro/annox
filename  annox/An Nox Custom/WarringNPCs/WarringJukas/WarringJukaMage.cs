...
namespace Server.Mobiles
{
	...
	public class WarringJukaMage : BaseCreature
	{
		[Constructable]
		public WarringJukaMage() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a juka mage";
			Body = 765;
            Team = 2;
		...
		public WarringJukaMage( Serial serial ) : base( serial )
		{
		}
