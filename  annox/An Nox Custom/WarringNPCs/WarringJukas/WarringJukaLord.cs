...
namespace Server.Mobiles
{
	...
	public class WarringJukaLord : BaseCreature
	{
		[Constructable]
		public WarringJukaLord() : base( AIType.AI_Archer, FightMode.Closest, 10, 3, 0.2, 0.4 )
		{
			Name = "a juka lord";
			Body = 766;
            Team = 2;
		...
		public WarringJukaLord( Serial serial ) : base( serial )
		{
		}
