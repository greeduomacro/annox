...
namespace Server.Mobiles
{
	...
	public class WarringOrcCaptain : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public WarringOrcCaptain() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public WarringOrcCaptain( Serial serial ) : base( serial )
		{
		}
