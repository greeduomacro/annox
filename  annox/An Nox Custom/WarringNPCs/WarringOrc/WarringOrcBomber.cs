...
namespace Server.Mobiles
{
	...
	public class WarringOrcBomber : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public WarringOrcBomber() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 182;
		...
		public WarringOrcBomber( Serial serial ) : base( serial )
		{
		}
