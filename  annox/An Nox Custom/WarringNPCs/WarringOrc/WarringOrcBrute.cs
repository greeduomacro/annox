...
namespace Server.Mobiles
{
	...
	public class WarringOrcBrute : BaseCreature
	{
		[Constructable]
		public WarringOrcBrute() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 189;
		...
		public WarringOrcBrute( Serial serial ) : base( serial )
		{
		}
