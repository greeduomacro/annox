...
namespace Server.Mobiles
{
	...
	public class WarringOrcishLord : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public WarringOrcishLord() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an orcish lord";
			Body = 138;
			BaseSoundID = 0x45A;
		...
		public WarringOrcishLord( Serial serial ) : base( serial )
		{
		}
