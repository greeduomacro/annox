...
{
    public class LeggingsOfTheDeep : PlateLegs // Your Armor name(no spaces) : Name of base Armor ie: PlateLeggings (remember to capitalize both names)
    {
        ...
        [Constructable]
        public LeggingsOfTheDeep()
        {
            Weight = 1.5;
            Name = "Leggings Of The Deep";
            Hue = 1176;
        ...
        public LeggingsOfTheDeep(Serial serial)
            : base(serial)
        {
        }
