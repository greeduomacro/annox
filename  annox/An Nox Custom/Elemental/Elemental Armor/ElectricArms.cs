...
{
    public class ElectricArms : PlateArms // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public ElectricArms(Serial serial)
            : base(serial)
        {
        }
