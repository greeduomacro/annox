...
{
    public class GlovesOfTheDeep : PlateGloves // Your Armor name(no spaces) : Name of base Armor ie: PlateGloves (remember to capitalize both names)
    {
        ...
        [Constructable]
        public GlovesOfTheDeep()
        {
            Weight = 1.5;
            Name = "Gloves Of The Deep";
            Hue = 1176;
        ...
        public GlovesOfTheDeep(Serial serial)
            : base(serial)
        {
        }
