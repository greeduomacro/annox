...
{
    public class ElectricTunic : ChainChest // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        [Constructable]
        public ElectricTunic()
        {
            Weight = 2.2;
            Name = "Tunic Of Electricity";
            Hue = 722;
        ...
        public ElectricTunic(Serial serial)
            : base(serial)
        {
        }
