...
{
    public class FrostGloves : PlateGloves // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public FrostGloves(Serial serial)
            : base(serial)
        {
        }
