...
{
    public class FrostGorget : PlateGorget // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public FrostGorget(Serial serial)
            : base(serial)
        {
        }
