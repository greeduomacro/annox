...
{
    public class ToxicGloves : PlateGloves // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public ToxicGloves(Serial serial)
            : base(serial)
        {
        }
