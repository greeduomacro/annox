...
{
    public class FrostArms : PlateArms // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public FrostArms(Serial serial)
            : base(serial)
        {
        }
