...
{
    public class ToxicLegs : ChainLegs // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public ToxicLegs(Serial serial)
            : base(serial)
        {
        }
