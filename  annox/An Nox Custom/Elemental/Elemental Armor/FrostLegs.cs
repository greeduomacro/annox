...
{
    public class FrostLegs : ChainLegs // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public FrostLegs(Serial serial)
            : base(serial)
        {
        }
