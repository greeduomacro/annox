...
{
    public class ElectricHelm : PlateHelm // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public ElectricHelm(Serial serial)
            : base(serial)
        {
        }
