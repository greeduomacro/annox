...
{
    public class ElectricGorget : PlateGorget // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        [Constructable]
        public ElectricGorget()
        {
            Weight = 2.2;
            Name = "Gorget Of Electricity";
            Hue = 722;
        ...
        public ElectricGorget(Serial serial)
            : base(serial)
        {
        }
