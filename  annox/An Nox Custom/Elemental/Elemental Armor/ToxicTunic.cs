...
{
    public class ToxicTunic : ChainChest // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public ToxicTunic(Serial serial)
            : base(serial)
        {
        }
