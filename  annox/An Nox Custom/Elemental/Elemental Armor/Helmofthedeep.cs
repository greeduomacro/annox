...
{
    public class HelmOfTheDeep : PlateHelm // Your Armor name(no spaces) : Name of base Armor ie: PlateHelm (remember to capitalize both names)
    {
        ...
        public HelmOfTheDeep(Serial serial)
            : base(serial)
        {
        }
