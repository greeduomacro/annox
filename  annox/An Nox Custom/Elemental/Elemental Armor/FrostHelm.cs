...
{
    public class FrostHelm : PlateHelm // Your Armor name(no spaces) : Name of base Armor ie: PlateChest (remember to capitalize both names)
    {
        ...
        public FrostHelm(Serial serial)
            : base(serial)
        {
        }
