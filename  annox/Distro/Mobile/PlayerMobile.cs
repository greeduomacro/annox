//14JUL2006 add "Working Death" 
//19SEP2007 add "Auto Defend When Attacked" by Anvil
//10OCT2007 PvP Skulls by XenoNeo
//24MAR2008 Lucid's Anti Res Kill System
//05AUG2008 Challenge Game 
...
namespace Server.Mobiles
{
    ...
    public enum PlayerFlag // First 16 bits are reserved for default-distro use, start custom flags at 0x00010000
    {
        ...
        //05AUG2008 Challenge Game *** START ****
        isinchal = 0x00100001,
        canbechal = 0x00100002,
        TempMount = 0x00100003
        //05AUG2008 Challenge Game *** END   ****
    }
    ...
    public class PlayerMobile : Mobile, IHonorTarget
    {
        ...
        {
            //14JUL2006 add "Working Death" *** START ***
            //Old version, replaced with below
            {
                Mobile m = new Death();
                m.Location = c.Location;
                m.Map = c.Map;
                Effects.PlaySound(c.Location, c.Map, 0x237);
            }
            //02SEP2006 Put the old Death back because it worked better.

            //10OCT2007 PvP Skulls by XenoNeo *** START ***
            if (c is Corpse)
            {
            ...
            //10OCT2007 PvP Skulls by XenoNeo *** END   ***
