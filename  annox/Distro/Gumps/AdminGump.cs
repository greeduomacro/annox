//19OCT2006 Replace 'View Empty Accounts' with 'Total Game Timer <= 3 Minutes'
using System;
using System.Net;
using System.Text;
...
namespace Server.Gumps
{
    ...
    public class AdminGump : Gump
    {
        ...
        public void AddAccountHeader()
        {
            ...
            //Replace 'View Empty Accounts' with 'Total Game Timer <= 3 Minutes'  *** START ***
            //AddButtonLabeled(200, 80, GetButtonID(5, 30), "View All: Empty");
            AddButtonLabeled(200, 80, GetButtonID(5, 30), "View All: 3 Minutes");
            //Replace 'View Empty Accounts' with 'Total Game Timer <= 3 Minutes'  *** END   ***
                ...
                case 5:
                    {
                        switch (index)
                        {
                            ...
                            //19OCT2006 Replace 'View Empty Accounts' with 'Total Game Timer < 3 Minutes' *** END ***
                            ...
                            case 31: // View all inactive accounts
                                {
                                    ...
                                    DateTime minTime = DateTime.Now - TimeSpan.FromDays(365.0);
