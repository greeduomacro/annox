...
//11SEP2006 Listening Vendors by RavonTUS@Yahoo.com
//12FEB2007 Make NPC's killable
//17APR2007 Updated vendors to support Elven looking shopkeepers in Heartwood.
//23JUL2007 Support for 6.0.1.7 Client 
using System;
...
namespace Server.Mobiles
{
    ...
    public abstract class BaseVendor : BaseCreature, IVendor
    {
        ...
        //12FEB2007 Make vendors killable *** START ***
        //public virtual bool IsInvulnerable { get { return true; } }
        public virtual bool IsInvulnerable { get { return false; } }
        //12FEB2007 Make vendors killable *** END ***
        ...
        public virtual void TurnToElvenVendor()
        {
            ...
            switch (Utility.Random(7))
            {
                case 0:
                    {
                        AddItem(new ElvenShirt(GetRandomHue()));
                ...
                case 2:
                    {
                        AddItem(new ElvenDarkShirt(GetRandomHue()));
                        AddItem(new ElvenPants(GetRandomHue()));
                        AddItem(new ElvenBoots(GetRandomHue()));
                        break;
                    }
                case 3: AddItem(new ElvenShirt(GetRandomHue()));
                    {
                        AddItem(new ElvenPants(GetRandomHue()));
                        AddItem(new ElvenBoots(GetRandomHue()));
                        break;
