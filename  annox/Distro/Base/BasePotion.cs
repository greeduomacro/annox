//06OCT2006 Added Unequip, drink re-equip.
using System;
using Server;
...
namespace Server.Items
{
    ...
    public abstract class BasePotion : Item, ICraftable
    {
        ...
        {
            //06OCT2006 Unequip weapon, drink, re-equip weapon *** START ***
            Item item1;
            ...
            if (from.InRange(this.GetWorldLocation(), 1))
                ...
                {
                    from.SendLocalizedMessage(502172); // You must have a free hand to drink a potion.
                    //Now drop item in hand
                    item1 = from.FindItemOnLayer(Layer.TwoHanded);
                    from.Backpack.DropItem(item1);
                    from.SendMessage("Stash your stuff");
                    Drink(from);
                    from.SendMessage("Gulp Gulp Ahh!");
                    from.EquipItem(item1);
                }
            //06OCT2006 Unequip weapon, drink, re-equip weapon *** START ***
